...
@Data
@ValidWorkout
@Schema(description = "Request object for creating a new workout")
public class CreateWorkoutRequest {

    @Schema(description = "Date and time when the workout was performed", example = "2024-01-15T10:30:00", required = true)
