...
public class DataPopulationController {
        ...
        public Mono<ResponseEntity<String>> populateHevyData(
                ...
                log.info("Received request to populate {} workout plans from Hevy",
                                hevyApiResponse.getRoutines().size());
        ...
        public Mono<ResponseEntity<String>> createTestRoutineFolders() {
                ...
                return Mono.fromCallable(() -> {
                        ...
                        java.util.List<com.muscledia.workout_service.model.RoutineFolder> testFolders = java.util.Arrays
                                        .asList(
